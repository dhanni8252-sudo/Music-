"""
Premium Telegram Music Bot — Pro Level v7
Voice Chat Streaming via YouTube
"""
import os
import re
import asyncio
...
YDL_BASE = {
    ...
    "noplaylist": True,
    "http_headers": {
        "User-Agent": "Mozilla/5.0 (Linux; Android 14; SM-A047F Build/UP1A.231005.007) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.7778.120 Mobile Safari/537.36",
        "Cookie": "__Secure-YNID=18.YT=EBGo_-B95OH1laRreDfKbdY4eQpFlNJamQbgt301ewyemA7hGBLni978gumZJvAqQWIXvC7zCHWtjSlI-E-epJs0bNdjgkQLMrUiufJ9NjfHSTRVSA0B7kwJzwzCp99KnHF2-UJW7RrAsAN_9o4QQbF-sXC5f_BP6xesL85YB1LmglIBYxpgbPtJyZEq1ukhzOU5a5gwLkR20PkkiaPo2ypRtiHbFvTtOluCt5TitogG0wd-MNRn3VPTbNL_i-5dy-wTaQXLMaJ3nJJuIilWNyDryRLBtmeo_AiB-YM4IPUEMQQfm3jqqXB8Oc9gVFM7_lanh0bm6wsxvDEZ5qx6Ig; YSC=65sfPiyQ9xc; VISITOR_INFO1_LIVE=2TDvCiD9umY; VISITOR_PRIVACY_METADATA=CgJJThIEGgAgPA%3D%3D; PREF=tz=Asia.Calcutta; GPS=1; __Secure-ROLLOUT_TOKEN=CKPSmLD6n8_mDhCo2P6rodyUAxitl8zQqNyUAw%3D%3D; __Secure-1PSIDTS=sidts-CjQBhkeRd44AWOPy2re2dfW3mWsSUYKC6GGSHB4oHAM2W8sgL7vLWvgukgsfqoZ2nsjW_tFMEAA; __Secure-3PSIDTS=sidts-CjQBhkeRd44AWOPy2re2dfW3mWsSUYKC6GGSHB4oHAM2W8sgL7vLWvgukgsfqoZ2nsjW_tFMEAA; HSID=AkXSyfYX8HCJDAK53; SSID=AmdhzkmGe_n3ThTGi; APISID=vn5CR5RPw2IDSzMz/AXHzFpd98_BMcUOUO; SAPISID=shokmgY0ZG9KsFhp/APKRGfo9AW2dbeSRH; __Secure-1PAPISID=shokmgY0ZG9KsFhp/APKRGfo9AW2dbeSRH; __Secure-3PAPISID=shokmgY0ZG9KsFhp/APKRGfo9AW2dbeSRH; SID=g.a000-gjBqkCjx6QiBcXKsf7NmcRyWYCIpYI8GZ4g9GejaK49NDOYF4lLpxn0lAuQNEezJC-BMQACgYKAS0SARcSFQHGX2MiJRZJjDVQK2tTc9E3hAGmExoVAUF8yKovWtX8KUATNl45ldPBQ2nk0076; __Secure-1PSID=g.a000-gjBqkCjx6QiBcXKsf7NmcRyWYCIpYI8GZ4g9GejaK49NDOY-GxVPJmTm5lu2h1SMO26KgACgYKAfASARcSFQHGX2Mi0MaskSSpG3HTApiofMGooBoVAUF8yKpqrsfuV2N4xmKq7sMba81d0076; __Secure-3PSID=g.a000-gjBqkCjx6QiBcXKsf7NmcRyWYCIpYI8GZ4g9GejaK49NDOYG-Tjpg5O8VE252lDFCgbaAACgYKAXQSARcSFQHGX2Mix3auPgxx5RDmLrutKRhlXRoVAUF8yKptIi4zusBelzC0rTEAfk6f0076; YTSESSION-jnufdw=ANPz9KiCjOI7DTy48g90dG/5cvqrdBXuO4g5JHvH6VIiD1xnBjZ8cDc5c0BRihooVmzggM7volhEjtWx6CDlaMGGm9lW8banYywOJ+g=; LOGIN_INFO=AFmmF2swRQIhANb6IW9Wq8R4i_u6ids-r5XcGcvYkAGh02ir2K0d9ieAAiBE2dbEXUSAkbPwBIF3V5-qDeacHNFbh8orIM6T_WiCag:QUQ3MjNmekR2S0JlRVN3LTB5bzVnVXRKbGVwcWlfSEpHRmRjZ0MzZmpPc3I2THBUVl9ibzhKMXJqN0RtT3lVYTFZa1ZLRTFlQW9FTWxtd0dmc3Q1Y3h1Mnh1NzFTUTZqRlBHSGJMX0x6S2pTazRrZDVrODU4cWZsZk1jYTlJSzBZOVZRN3hrdklOSElZcTdielpUalZEX0R0WkJQOUV3TmJB; YTSESSION-1nge1wu=ANPz9KhyEqoFDmXDpw/+T8EHP30gWosyvZBPnDKfT0Us+BNLYskW0ymbbKTpk/C8aiMao6Q+AfXtwa9GQfVXFuNueZ/GsJpNGR5/WDs=; SIDCC=AKEyXzVDexndeLYSfomsOvYUvdKVadIrHQegPpcrcpp0z0qJYgTddSytnWBmO-W5jjbRLjqFAg; __Secure-1PSIDCC=AKEyXzUxpwhOudOH2wTCpGtXaVdiQcYZwjpjZvA0zl0PacMYOI4w6606wEcMBF0XUPpgcU5M; __Secure-3PSIDCC=AKEyXzU_fpxmDolU5SGzTTi9OulDGYWmgExhMYQ7pK2cHpUnBKq0Dyilc4bZKUBEcQlycysp"
    }
}

def get_audio(query: str) -> dict:
    is_url = YOUTUBE_RE.match(query.strip())
    opts = {
        **YDL_BASE,
        "format": "bestaudio[ext=webm]/bestaudio/best",
        "default_search": "ytsearch" if not is_url else "auto",
    }
    with YoutubeDL(opts) as ydl:
        ...
        return {
            ...
            "yt_url":    info.get("webpage_url") or info.get("url", ""),
        }

def search_yt(query: str, n: int = 5) -> list[dict]:
    opts = {**YDL_BASE, "format": "bestaudio/best",
            "default_search": f"ytsearch{n}", "noplaylist": False}
    with YoutubeDL(opts) as ydl:
        info = ydl.extract_info(query, download=False)
        out = []
        for r in (info.get("entries") or [])[:n]:
            if r:
                out.append({
                    "title":     r.get("title", "?"),
                    ...
                    "yt_url":    r.get("webpage_url") or r.get("url", ""),
                })
        return out
...
def np_caption(track: dict, chat_id: int) -> str:
    ...
    if yt_url:
        lines.append(f"🔗 [Watch on YouTube]({yt_url})")
    return "\n".join(lines)

def np_text_only(track: dict) -> str:
    """Compact text when no thumbnail available."""
    title  = track.get("title", "Unknown")
...
async def ensure_assistant_in_group(chat_id: int, chat_username: str = "") -> bool:
    """Try to auto-join assistant to group if not already a member."""
    if not user:
        return False
    try:
        ...
        pass
    # Try joining via username (public groups)
    if chat_username:
        try:
            ...
            pass
    # Try joining via chat_id (invite link method for private groups via bot)
    try:
...
async def send_now_playing(target, track: dict, chat_id: int, edit: bool = False):
    """Send or edit the now playing message with thumbnail."""
    ...
    if thumb_data:
        ...
        if edit:
            ...
            if hasattr(target, "chat"):
                await target.chat.send_photo(photo, caption=caption,
                                             reply_markup=kb)
            else:
...
async def cmd_play(_, m: Message):
    ...
    # Auto-join assistant to group if not a member
    if vc_ready():
    ...
    try:
        ...
        await msg.edit(
            ...
            "_Try a different name or YouTube URL_"
        )
        return
...
async def cmd_search(_, m: Message):
    ...
    msg = await m.reply("🔍 **Searching top 5 results...**")
    try:
